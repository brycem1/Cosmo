...
embed()
plt.figure(1)
plt.plot(L1[0:999],Cl_BB_res[0:999],label = 'Cl_BB_lens_flat',c='b')
plt.plot(L1[0:999],Cl_BBl[0:999],label = 'Cl_BB_lens_camb',c='r')
plt.xscale('log')
plt.yscale('log')
...
plt.figure(2)
plt.plot(L1[0:999],Cl_BB_res[0:999]/Cl_BBl[0:999])
plt.xscale('log')
plt.yscale('log')
plt.title('flat-CAMB')
plt.xlabel('L')
